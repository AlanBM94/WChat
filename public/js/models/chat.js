export default class Chat {
    ...
    async buscaCoordenadas() {
        ...
        await $.ajax({
            method: "GET",
            url: `https://devru-latitude-longitude-find-v1.p.rapidapi.com/latlon.php?location=${this.usuarioCiudad}`,
            dataType: 'json',
            headers: {
    ...
    async getID(coordenadas) {
        ...
        await $.ajax({
            method: "GET",
            url: `https://api.openweathermap.org/data/2.5/weather?lat=${coordenadas.latitud}&lon=${coordenadas.longitud}&appid=acf3ea683407fd3d8ba8d12e5c57f2b9&units=metric`,
            dataType: "json"
        }).done(function (data) {
            return data
    ...
    async getPronostico(coordenadas) {
        ...
        await $.ajax({
            method: "GET",
            url: `https://api.openweathermap.org/data/2.5/forecast?lat=${coordenadas.latitud}&lon=${coordenadas.longitud}&appid=acf3ea683407fd3d8ba8d12e5c57f2b9&units=metric`,
            dataType: "json"
        }).done(function (data) {
            return data
        }).then(data => {
    ...
    filtrarPronosticoHoy(dias) {
        ...
        let fechaNueva = `${fecha.getFullYear()}-${this.mes(fecha.getMonth())}-${this.dia(fecha.getDate())}`;
